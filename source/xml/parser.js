...
(function () {
    ...
    function setup(VastXmlLoader, VastModelAd, VastModelCreativeCompanion, VastModelCreativeLinear, VastModelCompanion, VastModelMediaFile, VastModelTracking) {
    ...
    if (typeof define === "function" && define.amd) {
        define('vast/xml/parser', [
            'vast/xml/loader',
            'vast/models/ad', 
            'vast/models/creativeCompanion', 
            'vast/models/creativeLinear', 
            'vast/models/companion', 
            'vast/models/mediafile', 
            'vast/models/tracking'
        ], setup);
    } else if (typeof window === "object" && typeof window.document === "object") {
        window.Vast            = window.Vast || {};
        window.Vast.Xml        = window.Vast.Xml || {};
        window.Vast.Xml.Parser = window.Vast.Xml.Parser || setup(
            window.Vast.Xml.Loader,
            window.Vast.Models.Ad,
            window.Vast.Models.CreativeCompanion,
            window.Vast.Models.CreativeLinear,
            window.Vast.Models.Companion,
            window.Vast.Models.MediaFile,
