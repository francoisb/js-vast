...
(function () {
    ...
    function setup(VastPlayerBase, Modernizr) {
    ...
    if (typeof define === "function" && define.amd) {
        define('vast/players/mediafile/html5', [
            'vast/players/base',
            'modernizr'
        ], setup);
        ...
        window.Vast.Players.MediaFile       = window.Vast.Players.MediaFile || {};
        window.Vast.Players.MediaFile.Html5 = window.Vast.Players.MediaFile.Html5 || setup(
