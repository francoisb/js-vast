...
(function () {
    ...
    function setup(VastPlayerMediaFileHtml5, Modernizr) {
    ...
    if (typeof define === "function" && define.amd) {
        define('vast/models/mediafile', [
            'vast/players/mediafile/html5',
            'modernizr'
        ], setup);
    } else if (typeof window === "object" && typeof window.document === "object") {
        window.Vast                  = window.Vast || {};
        window.Vast.Models           = window.Vast.Models || {};
        window.Vast.Models.MediaFile = window.Vast.Models.MediaFile || setup(
            window.Vast.Players.MediaFile.Html5,
            window.Modernizr
        );
    }
